...
export default component$(() => {
  return (
    ...
    <div class="flex justify-between">
      ...
      <span class="bg-transparent text-neutral-500 rounded uppercase tracking-widest font-medium cursor-default">{new Date().toLocaleString()}</span>
      </div>
      
      <div>
        <a class="px-3 py-3 inline-block justify-center place-content-center" href="/" title="JPLogo">
          <JPLogo />
        </a>
      </div>

      <ul class="flex flex-row flex-wrap text-right space-x-4 py-4 px-4 font-sans-serif font-medium text-sm">
