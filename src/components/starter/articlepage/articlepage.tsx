    ...
    return (
      <article class="container mx-auto">
        <section class="flex h-full flex-col items-center space-y-2">
          <div class="md:pb-1 text-xs self-start pt-8 pb-1 px-3.5 lg:pl-40">
          ...
          <h1 class="text-4xl font-bold font-serif pt-1.5 md:pt-3 pb-3 px-3.5 self-start lg:pl-40">
            {headline2}
          </h1>
          <h2 class="font-serif pt-1 pb-6 px-3.5 self-start lg:pl-40 break-normal max-w-5xl">
            {teaser}
          </h2>
          ...
          <div class="w-full">
            <hr class="h-0.5 my-4 bg-black border-2 mx-2 md:mx-0" />
          </div>
